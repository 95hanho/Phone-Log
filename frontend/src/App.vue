        ...
        <div id="accordion">
          <div class="card card-default">
            <div class="card-header" style="height:65px;background:#ddddd6;">
              ...
              <button v-if="$cookies.get('refreshToken')" @click="logout" class="btn btn-info float-right btn-sm" style="margin-left:5px">
                LOGOUT
              </button>
              <button v-if="admin&&$cookies.get('refreshToken')" @click="infoBtn" class="btn btn-success float-right btn-sm" style="margin-left:5px">
                INFO
              </button>
            </div>
          </div>
          ...
          <div class="card card-default" style="margin-top:56px;">
            <div class="card-header" style="height:80px;background:#ddddd6;">
            </div>
          </div>
        </div>
      </div>
